...
angular.module('mean.articles').config(['$stateProvider',
    function ($stateProvider) {
        ...
        $stateProvider
            ...
            .state('review order', {
                url:'/reviewOrder',
                templateUrl: 'articles/views/reviewOrder.html',
                resolve: {
                    loggedin: checkLoggedin
                }
            })
            ...
            .state('order by id', {
                ...
                templateUrl: 'articles/views/successOrder.html',
                resolve: {
                    loggedin: checkLoggedin
                }
            })
            .state('edit Order', {
                url: '/editOrder',
                templateUrl: 'articles/views/editOrder.html',
                resolve: {
                    loggedin: checkLoggedin
                }
            })
            .state('view all orders', {
                url: '/orders',
                templateUrl: 'articles/views/orders.html',
                resolve: {
                    loggedin: checkLoggedin
                }
            });
